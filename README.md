# Data agnostic Lightgbm Classifier with docker compose and Plumber API  

* The idea of this project is to have a data agnostic lightgbm classifier that trains, predicts and serves as a docker compose service.
...
```
docker compose exec -it lightgbm_classifier ./train
...
```
docker compose exec -it lightgbm_classifier ./serve 
```
